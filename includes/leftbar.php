        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        <li><a href="create-subject.php"><i class="fa fa-plus"></i> <span>Crear Cursos</span></a></li>
                        <li><a href="manage-subjects.php"><i class="fa fa-bars"></i> <span>Gestionar Cursos</span></a></li>
                        <li><a href="add-subjectcombination.php"><i class="fa fa-plus"></i> <span>Gestionar Relación de Cursos</span></a></li>
                        <a href="manage-subjectcombination.php"><i class="fa fa-bars"></i> <span>Ver Relación de Cursos</span></a>
                </li>
            </ul>
            </li>
            <li class="has-children">
            ...
            <li><a href="reportes.php"><i class="fa fa-file-o"></i> <span>Reporte</span> <i class="fa fa-angle-right arrow"></i></a></li>
