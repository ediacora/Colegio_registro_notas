...
<head>
    ...
    <title>Colegio "fe y ciencia"</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="navbar-header no-padding">
                        <a class="navbar-brand" target="a_blank" href=""margin-left= auto margin-right= auto >
                            <img src="logo7.jpg" alt="foto perfil" height="35" style="border-radius: 50px;" text-aling= center> 
